  ...
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center items-center px-6 py-10">
      <div className="max-w-3xl bg-white p-8 rounded-2xl shadow-lg">
        ...
        {/* Website Name */}
        <h1 className="text-4xl font-bold text-gray-800 mb-2"><span className="text-red-500 font-semibold">A</span>z Shopping</h1>
        <p className="text-gray-500 mb-6">Your Trusted Online Shopping Partner</p>

        {/* About Az */}
        <h2 className="text-2xl font-semibold text-red-500 mb-3"><strong>About A<span className="text-black">z</span></strong> </h2>
        <p className="text-gray-600 leading-relaxed mb-6 font-semibold">
          ...
          modern technology and clean UI design. At <span className="text-red-500 font-semibold">A</span>z, we focus on 
          convenience, quality, and trust.
        </p>

        {/* Why Choose Az */}
        <h2 className="text-2xl font-semibold text-red-500 mb-3">Why Choose A<span className="text-black">z?</span></h2>
        ...
        <p className="text-gray-600 leading-relaxed mb-6 font-semibold">
          Our vision at <strong className="text-red-500">A<span className="font-semibold text-black">z</span></strong> is to build the most reliable and 
